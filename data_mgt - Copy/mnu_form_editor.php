         ...
         data_list.forEach(function(itm) {
          // console.log("data: "+itm.data_id);
           //addRow_DataForm(data_id, data_name,  data_type, data_seq, data_sub_list){
            ...
            addRow_ComponentForm(itm.data_id, itm.data_type ,itm.data_seq, itm.data_value);
            else{
...
function updateReq(dataID){
  ...
  if($("#c"+dataID).is(':checked')){
    ...
    function addRow_ComponentForm(data_id, data_type, data_seq, data_value){
    //  var data_value = data_value.replace(/\"/g, '\\\"');
      ...
      if(data_type == "q_label"){
        ...
        comp = '<div><textarea id="v'+data_id+'" data-odata="'+data_value+'" data-col="data_value" class="form-control form-control-sm c'+data_id+'"  rows="4">'+data_value+'</textarea></div>';
      //  comp = '<div><textarea id="v'+data_id+'" data-odata=""  data-col="data_value" class="form-control form-control-sm c'+data_id+'"  rows="4">'+data_value+'</textarea></div>';

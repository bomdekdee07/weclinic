...
$sDataid = getQS("dataid");
  ...
  $ATTR_DATATYPE['number'] = array('showlabel','width','minvalue','maxvalue','placeholder','hideprefixsuffix','tagname','keyname');
  ...
  $ATTR_DATATYPE['radio'] = array('showlabel','optalign','hidesomechoice','tagname','keyname');// V (vertical), H (horizontal)
  $ATTR_DATATYPE['date'] = array('showlabel','width','placeholder','hideprefixsuffix','partialdate', 'isthaidate','tagname','keyname' );
...
//echo "<br>$attr_id / $attr_val";
  if($attr_id == "showlabel"){
    ...
    $attr_comp = "<select class='save-data v-dropdown' data-id='$attr_id'  data-odata='$attr_val'><option value='V'>Vertical</option><option value='H'>Herizontal</option></select>";

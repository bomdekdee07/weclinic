...
//$cur_menu = isset($_SESSION["cur_menu"])?$_SESSION["cur_menu"]:"";
//echo "curmenu: ".$_SESSION["cur_menu"];
if(isset($_SESSION["cur_menu"])){
  $cur_menu = $_SESSION["cur_menu"];
  if($cur_menu != ""){
    // remove this when seperate poc to w_proj_POC completely
    if($cur_menu == "POC")
    include_once("w_user/index.php");
    else if($cur_menu == "LAB")
    include_once("lab/index.php");
    else if($cur_menu == "DM")
    include_once("data_mgt/index.php");
    else if($cur_menu == "uid_mgt")
    include_once("w_uid_mgt/index.php");
    else
    include_once("w_proj_$cur_menu/index.php");
    //--------------------------------------------------

    //include_once("w_proj_$cur_menu/index.php"); // replace this one when complete w_proj_POC
  }
  else{

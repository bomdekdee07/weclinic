...
if($flag_auth != 0){ // valid user session
  ...
  if($u_mode == "schedule_data"){ // select schedule data
    ...
    if($txt_search != "")
    $query_add .= " AND (ul.pid LIKE '$txt_search'  OR u.uic2 LIKE '$txt_search' OR u.uid LIKE '$txt_search') ";
...
/*
     ...
     $query_add .= " AND uv.group_id LIKE '$project_group_id' ";
*/

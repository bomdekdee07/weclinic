...
// all poc visit
$sheet_visit = $project_id."_all_visit";
$row_head = array();
...
$inQuery = "SELECT u.uid, ug.uic2, u.pid,  v.visit_id, vs.status_name, v.group_id, v.visit_date
...
and v.visit_status <> 0
and u.uid_status=1 and v.visit_status=vs.status_id

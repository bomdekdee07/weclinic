...
function confirm_consent(choice, p_consent, uid_param, screenDate, visitDate){
  ...
  console.log("uid:"+aData.uid+"/case_consent:"+aData.case_consent+"/screen_date:"+aData.screen_date+"/visit_date:"+aData.visit_date+"/confirm_choice:"+aData.confirm_choice);

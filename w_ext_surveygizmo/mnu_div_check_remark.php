    ...
    <div class="row">
      ...
      <div class="col-sm-3">
       ...
       <div class="col-sm-2">
         ...
         <label for="btn_search_surveygizmo3" class="text-light">.</label>
         <button class="btn btn-info form-control" type="button" id="btn_search_surveygizmo3"><i class="fa fa-search" ></i> ค้นหา</button>
...
$(document).ready(function(){
  ...
  $("#btn_search_surveygizmo3").click(function(){
     searchSGM_Remark();
  }); // btn_search_surveygizmo3
...
function searchSGM_Remark(){
    ...
    save_data_ajax(aData,"w_ext_surveygizmo/db_surveygizmo.php",searchSGM_RemarkComplete);
  ...
  if(rtnDataAjax.datalist.length > 0){
    var datalist = rtnDataAjax.datalist;
      ...
      //    btn_check = ' <span id="b'+id+'"><button id="btn_'+id+'" class="btn btn-sm  btn-success" type="button" onclick="checkReviseSG_FormDone(\''+dataObj.uic+'\',\''+dataObj.r_uic+'\',\''+dataObj.visit_date+'\',\''+dataObj.form_id+'\')""> <i class="fa fa-check"></i> ตรวจการแก้ UIC</button></span>';
          btn_check = ' <button id="btn_'+id+'" class="btn btn-sm  btn-success" type="button" onclick="checkRemarkSG(\''+dataObj.uic+'\',\''+dataObj.visit_date+'\')""><i class="fa fa-check"></i> ตรวจ Note</button>';
...
function checkRemarkSG(c_uic, c_visit_date){
  var aData = {
  ...
  save_data_ajax(aData,"w_ext_surveygizmo/db_surveygizmo.php",checkRemarkSGComplete);
}

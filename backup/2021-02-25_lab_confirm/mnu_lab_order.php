        ...
        for (i = 0; i < datalist.length; i++) {
            ...
            addRowData_LabOrder(
             ...
             dataObj.status_id, dataObj.status_name, dataObj.wait_lab_result,
              dataObj.request_by, dataObj.room_no, dataObj.clinic_type
...
function addRowData_LabOrder(lab_order_id,  uid, collect_date, collect_time,
  status_id, status_name,wait_lab_result, request_lab_by, requested_room_no, clinic_type){
    ...
    txt_row += '<td width="10%">'+status_name+'</td>';
    txt_row += '<td width="20%">'+request_lab_by+'</td>';
    txt_row += '<td width="15%">'+wait_lab_result+'</td>';
    txt_row += '<td>';
    txt_row += '<button class="btn btn-primary" type="button" onclick="openLabOrder(\''+uid+'\', \''+collect_date+'\', \''+collect_time+'\');"> <b> Lab Order</b></button>';
    txt_row += '</td>';
    txt_row += '<td>';
    txt_row += '<button class="btn btn-warning" type="button" onclick="openSpecimenCollect(\''+uid+'\', \''+collect_date+'\', \''+collect_time+'\');"> <b> Specimen Collected</b></button>';
    txt_row += '</td>';
    txt_row += '<td>';
    txt_row += '<button class="btn btn-info" type="button" onclick="openLabResult(\''+uid+'\', \''+collect_date+'\', \''+collect_time+'\');"> <b> Lab Result</b></button>';
    txt_row += '</td>';

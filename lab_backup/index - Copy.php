...
-->
    ...
    -->
    <button id="btn_lab_warning" class="btn btn-sm btn-white my-2 my-sm-0" type="button"><i class="fas fa-volume-up "></i> Warning</button>
    </div>
  </nav>

<div class="container-fluid" style="margin-top:0px">
  <div id="div_main" class="my-2">
    <div id="div_lab_order" class="div-main-lab">
   <?
              ...
              <div class="modal-header bg-primary text-white">
                <h4 class="modal-title ">
                  <i class="fa fa-volume-up fa-lg" aria-hidden="true"></i>
                   Warning: Specimen Collect / Specimen Check </h4>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
              </div>
...
$(".mnu-main").click(function(){
  // alert("main "+$(this).attr("id"));
   ...
   if(link == "mnu_lab_order.php"){
     //link = "mnu_lab_order.php?uid=P20-0001&visit_date=2020-10-30 11:21:36";
     link = "mnu_lab_order.php?uid=P20-0001&visit_date=2020-10-30_112136";
   }
...
function checkWarningSpecimen_Complete(flagSave, rtnDataAjax, aData){
    if(flagSave){
      ...
      data_list.forEach(function(itm) {
        var status_txt = (itm.s == "A2")?"Collect":"Check";

...
st.s_name as doctor_name , b.queue as qid, rd.id as qrd,o.staff_order_room,o.lab_order_status,br.fname,br.sname
FROM p_lab_order as o
...
*/
 $query = "SELECT o.uid, o.collect_date as c_date, o.collect_time as c_time,
 o.time_confirm_order as cf_time, o.wait_lab_result,
 st.s_name as doctor_name , b.queue as qid, rd.id as qrd,o.staff_order_room,o.lab_order_status,P.fname,P.sname,P.date_of_birth as dob
 FROM p_lab_order as o
 LEFT JOIN p_staff as st
 ON st.s_id = o.staff_order
 ...
 LEFT JOIN k_visit_data as b
 ON  o.uid=b.uid
 AND  o.collect_date=b.date_of_visit
 AND binary o.collect_time=b.time_of_visit
...
o.lab_order_id,o.uid, o.collect_date as c_date, o.time_confirm_order as c_time, o.lab_order_note,
  st.s_name as doctor_name , b.queue as qid, rd.id as qrd,o.staff_order_room,o.lab_order_status,br.fname,br.sname,date_o_b ,mon_o_b,y_o_b
  FROM p_lab_order as o
  LEFT JOIN p_staff as st
  ON st.s_id = o.staff_order
  ...
  LEFT JOIN k_queue_row_detail as rd on
  (rd.patient_uid = b.uid AND b.queue=rd.queue_row_detail)
  WHERE  o.uid=? AND o.collect_date=? AND o.collect_time=? AND o.lab_order_status = 'A2'";
...
//echo "query1: $uid, $collect_date, $collect_time / $query";
      ...
      AND t.lab_id = o.lab_id
      AND t.lab_group_id = ls.lab_group_id AND ls.specimen_id=sp.specimen_id

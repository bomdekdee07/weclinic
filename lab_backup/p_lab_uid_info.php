...
if (session_status() == PHP_SESSION_NONE) {
    ...
    include_once(realpath($_SERVER["DOCUMENT_ROOT"])."/weclinic/in_auth.php");
}
...
include(realpath($_SERVER["DOCUMENT_ROOT"])."/weclinic/in_db_conn.php");
  ...
  MD.data_name_th as md, CL.data_name_th as cl, RN.data_name_th as rn
  FROM patient_info P
  ...
  LEFT JOIN p_data_sub_list MD ON (p_staff_md.data_result=MD.data_value AND p_staff_md.data_id=MD.data_id)
  ...
  LEFT JOIN p_data_sub_list CL ON (p_staff_cl.data_result=CL.data_value AND p_staff_cl.data_id=CL.data_id)
  ...
  LEFT JOIN p_data_sub_list RN ON (p_staff_rn.data_result=RN.data_value AND p_staff_rn.data_id=RN.data_id)

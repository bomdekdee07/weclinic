...
function getStaffData(staffID, scID){
  //alert("getStaffData "+staffID);
  $('#cur_s_id').val(staffID);
  $('#cur_sc_id').val(scID);
  var aData = {
            u_mode:"get_staff_data",
            s_id:staffID
  };
  save_data_ajax(aData,"w_admin/db_staff_mgt.php",getStaffDataComplete);

}
function getStaffDataComplete(flagSave, rtnDataAjax, aData){

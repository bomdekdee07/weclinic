...
function searchsurveygizmo(){
    ...
    save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",searchsurveygizmoComplete);
...
function checkSG_FormDone(c_pid, c_acid, c_uic,c_visit_date){
  ...
  if(id != r_id){ // there is revised id
    ...
    save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",checkSG_FormDoneComplete);
...
function saveRemark(c_pid,c_acid,c_uic, c_visit_date){
      ...
      save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",saveRemarkComplete);

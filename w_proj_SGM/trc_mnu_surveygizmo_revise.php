    ...
    <div class="card-title">
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="row">
              <div class="col-sm-4">
                <button class="btn btn-primary form-control btn_mnu_sgm" type="button"  data-mnu="1" data-id="trc_mnu_div_id_revise"><i class="fa fa-file" ></i> ตรวจแก้ ID</button>
              </div>
              <div class="col-sm-4">
                <button class="btn btn-primary form-control btn_mnu_sgm" type="button"  data-mnu="2" data-id="trc_mnu_div_check_remark"><i class="fa fa-file" ></i> ตรวจแก้ Note</button>
              </div>
              <div class="col-sm-4">
                <button class="btn btn-primary form-control btn_mnu_sgm" type="button"  data-mnu="3" data-id="trc_mnu_div_surveygizmo_all"><i class="fa fa-file" ></i> ภาพรวม</button>
              </div>
          </div>
        </div>
        <div class="col-sm-6">
...
function loadSGM_Menu(choice, mnu){
  var link = "w_proj_SGM/"+choice+".php";

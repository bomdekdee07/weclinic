...
function searchSGM_Remark(){
    ...
    save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",searchSGM_RemarkComplete);
...
function checkRemarkSG(c_pid, c_acid,c_uic, c_visit_date){
  ...
  save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",checkRemarkSGComplete);
}

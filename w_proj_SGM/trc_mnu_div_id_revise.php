...
function searchSGM_Revise(){
    ...
    save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",searchSGM_ReviseComplete);
...
function checkReviseSG_FormDone(c_pid, c_acid, c_uic, rv_pid, rv_acid, rv_uic, c_visit_date, c_form_id){
    ...
    save_data_ajax(aData,"w_proj_SGM/trc_db_surveygizmo.php",checkReviseSG_FormDoneComplete);

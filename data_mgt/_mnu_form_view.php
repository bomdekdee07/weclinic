...
<div id="div_form_view_data" style="min-height:500px; padding-top:20px; padding-left:30px;" data-uid='<? echo($uid); ?>' data-coldate='<? echo($collect_date); ?>' data-coltime='<? echo($collect_time); ?>'>

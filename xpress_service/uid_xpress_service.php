        ...
        for (i = 0; i < datalist.length; i++) {
          ...
          if(dataObj.p_x_sum == 'Y'){ // pass assessment
            ...
            if(dataObj.p_c_agree == 'Y'){
              btn_visit_patient_consent = '<button class="btn btn-success btn-sm" type="button" onclick="view_xpress_service_consent(\''+dataObj.collect_date+'\',\'\',\'RAW\')"><i class="fa fa-check"></i> Consent Form <small>(ยอมรับ)</small></button>';
            }
            else if(dataObj.p_c_agree == 'N'){
              btn_visit_patient_consent = '<button class="btn btn-danger btn-sm" type="button" onclick="view_xpress_service_consent(\''+dataObj.collect_date+'\',\'\',\'RAW\')"><i class="fa fa-times"></i> Consent Form <small>(ไม่ยอมรับ)</small></button>';
            }
            else {
...
// counselor
    if(dataObj.c_uid != ''){
      if(dataObj.c_x_sum == 'Y'){
        btn_visit_counselor = '<button class="btn btn-success btn-sm " type="button" onclick="view_xpress_service(\''+dataObj.collect_date+'\',\''+csl_edit+'\',\'CSL\')"><i class="fa fa-check"></i> XPress Form <small>(ผ่าน)</small></button>';
        ...
        if(dataObj.c_c_agree == 'Y'){
          btn_visit_counselor_consent = '<button class="btn btn-success btn-sm " type="button" onclick="view_xpress_service_consent(\''+dataObj.collect_date+'\',\''+csl_edit+'\',\'CSL\')"><i class="fa fa-check"></i> Consent Form <small>(ยอมรับ)</small></button>';
          ...
          btn_visit_counselor_consent = '<button class="btn btn-danger btn-sm " type="button" onclick="view_xpress_service_consent(\''+dataObj.collect_date+'\',\''+csl_edit+'\',\'CSL\')"><i class="fa fa-times"></i> Consent Form <small>(ไม่ยอมรับ)</small></button>';
        }
        else {
        ...
        btn_visit_counselor = '<button class="btn btn-danger btn-sm " type="button" onclick="view_xpress_service(\''+dataObj.collect_date+'\',\''+csl_edit+'\',\'CSL\')"><i class="fa fa-times"></i> XPress Form <small>(ไม่ผ่าน)</small></button>';

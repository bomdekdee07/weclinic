...
//$web_link_qrcode = $GLOBALS['site_path']."visit_form/x_xpress_service.php?link=$link_encode";
$web_link_qrcode = $GLOBALS['site_path']."xpress_service/xpress_service_info.php?link=$link_encode";

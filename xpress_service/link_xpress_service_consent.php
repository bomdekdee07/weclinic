...
$form_title = "<h1><span style='font-size:40px;'>แบบฟอร์ม XPress Consent</span></h1>";

$link_encode = "$uid:$visit_date:$uic:$site";
//echo $link_encode;
$link_encode = encodeSingleLink($link_encode);

$web_link_qrcode = $GLOBALS['site_path']."visit_form/x_xpress_service_consent.php?link=$link_encode&r=$x_result";

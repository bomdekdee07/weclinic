...
function getAEForm_pid(seq_no){
  ...
  var link = "w_hos/pid_hos_ae_form.php?";
...
function getAE_pid(){
 ...
 function getAEList_pid(){
   //alert("getAE_pid 1 ");
     ...
     save_data_ajax(aData,"w_hos/db_hos_pid.php",getAEList_pidComplete);
 ...
 function getAEListRetention_pid(){
   ...
   function delete_ae(seqNo, collectDate, itmNo){
     ...
     if (result) {
       ...
       save_data_ajax(aData,"w_hos/db_hos_pid.php",delete_aeComplete);

        ...
        for (i = 0; i < datalist.length; i++) {
          ...
          if(dataObj.im == "0"){ // current data
            if(dataObj.art_pass == "1"){
              ...
              txt_btn_log += ' <td><button class="btn btn-block btn-'+rtn_color+'" type="button" onclick="goHosMnu(\''+dataObj.pid+'\', \'3\')""><i class="fa fa-stethoscope"></i> Retention  '+txt_rtn+'</button></td>';

...
คนที่มีผลตรวจเอชไอวีเป็นบวก ที่ รพ. ของท่าน <b>ตั้งแต่ 1 สิงหาคม 2561</b>
  ...
  <div class="row mt-2">
    <div class="col-sm-1">
     ...
     <div class="col-sm-2">
<!--
       <label for="search_hos_opt2">การติดตาม: </label>
       <select id="search_hos_opt2" class="form-control" >
         <option value="%" selected>All - ทั้งหมด</option>
         <option value="1">ติดตาม: ยังอยู่ในระบบรักษา/หยุดกินยาต้าน/ติดต่อไม่ได้/</option>
         <option value="2">ยังไม่เคยมีประวัติการติดตาม</option>
       </select>
-->
     </div>
     <div class="col-sm-3">

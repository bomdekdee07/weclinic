...
คนที่มีผลตรวจเอชไอวีเป็นบวก ที่ รพ. ของท่าน <b>ในช่วง 1 สิงหาคม 2560 ถึง 31 กรกฎาคม 2561</b>
  ...
  <div class="row mt-2">
     ...
     <!--
     <div class="col-sm-2">
       <label for="search_hos_pid_opt">ค้นหาจาก:</label>
       <select id="search_hos_pid_opt" class="form-control" >
         <option value="pid" selected >PID</option>
         <option value="citizen_id">บัตรประชาชน หรือ Passport</option>
         <option value="s_name">ชื่อ</option>
         <option value="f_name">นามสกุล</option>
       </select>
     </div>
   -->
     <div class="col-sm-4">
...
<div id='div_hos_pid_detail' class="div-hos-main mt-1">
  <div class="row bg-warning text-dark">
     <div class="col-sm-5">
       <h4>Retro <b><span id="title_hos_pid_detail" ></span></b></h4>
     </div>
     <div class="col-sm-6">
       ...
       <button type="button" class="btn btn-primary btn-hos-mnu btn-hos-mnu-main" data-id="2"><i class="fa fa-notes-medical fa-lg" ></i> Baseline</button>
        <button type="button" class="btn btn-warning btn-hos-mnu btn-hos-mnu-log" data-id="3"><i class="fa fa-stethoscope fa-lg" ></i> Retention</button>
        <button type="button" class="btn btn-warning btn-hos-mnu btn-hos-mnu-log" data-id="4"><i class="fa fa-procedures fa-lg" ></i> Adverse Event</button>

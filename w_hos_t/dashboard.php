...
<div id='div_hos_pid_list' class='div-hos-main mt-2'>
  <div class="row mt-1">
     <div class="col-sm-10">
       <h5><i class="fa fa-calendar-alt fa-lg" ></i> SAME DAY Hospital</h5>
     </div>
     <div class="col-sm-2">
       <!--
...
function addNewRowPID(pid, ul, name, hn,create_date){
  var txt_row ="";
  txt_row += '<tr class="r_hos_pid" id="r_'+pid+'" data-ul="'+ul+'" data-log="0" data-create="'+create_date+'" data-name="'+name+'">';
  txt_row += ' <td>'+pid+'</td>';
  txt_row += ' <td>'+ul+'</td>';
  txt_row += ' <td>'+name+'</td>';
  txt_row += ' <td>'+hn+'</td>';
...
function updateRowPID(pid, ul, name, hn,create_date){
  ...
  var txt_row ="";
  txt_row += '<tr class="r_hos_pid" id="r_'+pid+'" data-ul="'+ul+'" data-create="'+create_date+'" data-name="'+name+'">';
  txt_row += ' <td>'+pid+'</td>';
  txt_row += ' <td>'+ul+'</td>';
  txt_row += ' <td>'+name+'</td>';
  txt_row += ' <td>'+hn+'</td>';

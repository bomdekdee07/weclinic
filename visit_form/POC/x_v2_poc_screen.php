...
$require_form_complete = "Y"; // require that form must be completed before save data
...
$(document).ready(function(){
 ...
 $(".btn-screen").hide();
  ...
  //**** part 2 screen
  $("#is_risk_6mth_1n-Y").click(function(){ checkScreeningPart2(); });
  $("#is_risk_6mth_1n-N").click(function(){ checkScreeningPart2(); });
  ...
  $("#is_risk_6mth_4n-Y").click(function(){ checkScreeningPart2(); });
  $("#is_risk_6mth_4n-N").click(function(){ checkScreeningPart2(); });
  //******************
...
function checkScreeningPart2(){
  ...
  if($("#is_risk_6mth_1n-Y").is(':checked')) c2 += 1;
  if($("#is_risk_6mth_2-Y").is(':checked')) c2 += 1;
  if($("#is_risk_6mth_3-Y").is(':checked')) c2 += 1;
  if($("#is_risk_6mth_4n-Y").is(':checked')) c2 += 1;

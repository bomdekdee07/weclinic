...
if($tpha_prev != ''){
  ...
  $tpha_check .= '$("#tpha_notest").val("เคยตรวจTPHA ผลเป็นบวกใน POC มาก่อน");';
...
shData['ct_pool_result-I'] = {dtype:'radio', show_q:'ct_pool_invalid,ct_pool_result_re'};
...
shData['ng_pool_result-I'] = {dtype:'radio', show_q:'ng_pool_invalid,ng_pool_result_re'};
...
shData['tpha_result-NR'] = {dtype:'radio', hide_q:'rpr_result'};
shData['tpha_result-R'] = {dtype:'radio', show_q:'rpr_result'};
shData['tpha_result-I'] = {dtype:'radio', show_q:'rpr_result'};
shData['tpha_result-NT'] = {dtype:'radio', show_q:'rpr_result'};

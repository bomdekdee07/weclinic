...
$form_id = "v2_poc_m3";
$form_name = "Point of care Month3 v2";
...
if($group_id != "003" && $group_id != "004"){ //show option for group 3 & 4 only
  $initJSForm .= '$("#div-prep_ae2-NA").hide();'; // Not Applicable **เฉพาะกลุ่ม 3 และกลุ่ม 4
...
shData['groupchange-0'] = {dtype:'radio',
hide_q:'groupchange_txt'};
shData['groupchange-1'] = {dtype:'radio',
show_q:'groupchange_txt'};
shData['groupchange-3'] = {dtype:'radio',
show_q:'groupchange_txt'};
shData['groupchange-4'] = {dtype:'radio',
show_q:'groupchange_txt'};
";
 //$option_showhide = "";

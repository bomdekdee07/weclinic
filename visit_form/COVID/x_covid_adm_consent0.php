...
collect_date, name_title, name, sur_name, address,
...
LEFT JOIN p_staff as ps ON (v.consent_staff_check = ps.s_id COLLATE utf8_unicode_ci)
WHERE v.uid = ?
";
...
$form_id = "covid_consent";
$form_name = "COVID Group 4 ";
...
<div class="px-1 pt-2 pb-1" style="background-color:#C8F1FF;">
 ...
 <div>
   ...
   <input type="text" id="txt_name" class="form-control data-consent" placeholder="ชื่อ-นามสกุล">

...
$form_id = "covid_screen_g1";
$form_name = "COVID Screening Group 1 ";
...
function checkScreenPass_Covid(){
   ...
   var is_pass1 = "N";
   if($("#hist_covid_get-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }
   if($("#hist_covid_exam-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }
   if($("#hist_abroad-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }
   if($("#hist_crowded_place-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }
   if($("#hist_foreigner-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }
   if($("#hist_14day_risk-Y").prop("checked") == true){
     is_pass1 = 'Y';
   }

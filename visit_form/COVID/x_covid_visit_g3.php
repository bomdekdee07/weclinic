...
$form_id = "covid_visit_g3";
$form_name = "COVID Group 3 ";
...
<div class="my-4" id="divCovid_Form">
    ...
    <div><center><b><h4>แบบสอบถามชุดที่ 3 บุคลากรในสถานบริการสุขภาพ</h4></b></center></div>
    <div class="row my-2">
       <div class="col-sm-1"></div>
       <div class="col-sm-10">
         <div><center><u><b>คำชี้แจง</b></u></center></div>
         <div>
           <p>สถาบันเพื่อการวิจัยและนวัตกรรมด้านเอชไอวี (Institute of HIV Research and Innovation (IHRI)) ร่วมกับภาคีเครือข่ายที่เกี่ยวข้อง มีความประสงค์จะรวบรวมข้อมูลเกี่ยวกับความคิดเห็นและประสบการณ์การให้บริการสุขภาพและการอยู่ร่วมกับครอบครัว ชุมชน และสังคมของท่าน เพื่อนำไปใช้ในการพัฒนาคุณภาพบริการสุขภาพและการอยู่ร่วมกับครอบครัว ชุมชน และสังคม เพื่อลดการตีตราและเลือกปฏิบัติที่เกี่ยวกับโรคติดเชื้อไวรัสโคโรน่าสายพันธุ์ใหม่ หรือโควิด-19 (COVID-19) จึงขอความร่วมมือจากท่านในการตอบแบบสอบถามซึ่งจะใช้เวลาประมาณ 20 นาที </p>
           <p>การตอบแบบสอบถามนี้จะไม่กระทบต่อการทำงานทางด้านสุขภาพในอนาคตของท่านแต่อย่างใด คำตอบของท่านจะเป็นความลับ และไม่มีการถามข้อมูลส่วนบุคคลที่จะสามารถระบุตัวตนของท่านได้</p>
         </div>
       </div>
       <div class="col-sm-1"></div>
     </div>

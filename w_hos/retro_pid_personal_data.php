...
function getPersonalData_pid(){
  ...
  save_data_ajax(aData,"w_hos/db_hos_pid_retro.php",getPersonalData_pidComplete);
...
function savePersonalData_pid(){
  ...
  if(validateInput("div_hos1")){
    ...
    save_data_ajax(aData,"w_hos/db_hos_pid_retro.php",savePersonalData_pidComplete);

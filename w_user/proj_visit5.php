...
*/
        ...
        //  txt_row += ' <td>'+changeToThaiDate(dataObj.schedule_date)+btn_visit_schedule+'<br> <small>['+changeToThaiDate(dataObj.date_before)+" - "+changeToThaiDate(dataObj.date_after)+dataObj.d_after+']</small></td>';
          txt_row += ' <td>'+changeToThaiDate(dataObj.schedule_date)+btn_visit_schedule+'<br> <small>['+changeToThaiDate(dataObj.date_before)+" - "+changeToThaiDate(dataObj.date_after)+']</small></td>';
    //      txt_row += ' <td>'+changeToThaiDate(dataObj.schedule_date)+btn_visit_schedule+'<br> <small>['+changeToThaiDate(dataObj.d_before)+" - "+changeToThaiDate(dataObj.d_after)+']</small></td>';

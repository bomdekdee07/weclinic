...
$mnu_data_mgt = "";
          if(isset($auth["data"]) || isset($auth["export"]) || isset($auth["query"]) ){ // proj schedule
            ...
            if($s_section_id == "DATA" || $s_section_id == "TS"){ // for SDHOS
                $mnu_sdhos = $mnu_viewlog = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_hos" data-id="dashboard_center"><i class="fa fa-hospital fa-lg" ></i> SDART Hospital</a>';
            }
            ...
            if(isset($auth["data"])){
              ...
              //$mnu_schedule_proj .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_data_view" data-id="test_fixtable"><i class="fa fa-table"></i> ตารางนัดหมาย Point of Care 2</a>';
            ...
            if(isset($auth["query"])){
              ...
              if($staff_clinic_id == "%"){ // internal staff
                if($job_id == "MNT"){
                  //$mnu_schedule_proj = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_data_view" data-id="mnu_schedule_proj_POC"><i class="fa fa-table"></i> ตารางนัดหมาย Point of Care</a>';
                  $mnu_schedule_proj = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_data_view" data-id="mnu_schedule_proj_POC_log"><i class="fa fa-table"></i> ตารางนัดหมาย Point of Care</a>';
...
if($s_group == "0"){ // cbo staff
  ...
  if(($s_group == "1" && $s_section_id == "DATA") || $s_group == "99" ){ // ihri staff
    $mnu_surveygizmo = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_ext_surveygizmo" data-id="mnu_surveygizmo_revise"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo (Staff)</a>';
  }
}
            $mnu_data_mgt =  '
...
<div class="container-fluid" style="margin-top:30px">
  <div id="div_main">
    ...
    //  include_once("test_fixtable.php");

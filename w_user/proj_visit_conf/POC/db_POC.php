...
$last_proj_date = date('Y-m-d', strtotime($enroll_date. ' + 378 days')); //336+42 days
  ...
  // visit_day 	visit_day_before 	visit_day_after 	visit_order 	visit_status
           ...
           if($stmt->execute()){
            ...
            //   echo "last visit date/last proj date: $last_visit_date/$last_proj_date_1 --- datediff:$datediff";

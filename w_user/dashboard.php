  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-3">
      ...
      <div id="div_iclinic" class="mt-4">
         <?
         //echo "lv : ".$_SESSION['auth_level']."<br>";
            if(isset($_SESSION['auth_level'])){

              if(strval($_SESSION['auth_level']) != "x"){

                $link = "http://".$_SERVER['SERVER_NAME']."/iclinic/dashboard/auth_l_".$_SESSION['auth_level']."/";
                echo "<a href='$link' class='btn btn-white btn-block' target='_blank'>ทางลัดเข้าโปรแกรม <i class='fa fa-hospital fa-lg '></i> <b>iClinic</b></a>";
...
<div id="div_w_proj_SDHOS" class='div-main'></div>
<div id="div_w_data_view" class='div-main'></div>
<div id="div_w_monitor" class='div-main'></div>
<div id="div_w_proj_SGM" class='div-main'></div>
<div id="div_w_proj_SUT_PRE" class='div-main'></div> 
<div id="div_w_proj_covid19" class='div-main'></div>

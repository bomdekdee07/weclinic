...
$is_backdate = isset($_GET["bd"])?$_GET["bd"]:"N"; // Y: can be fill backdate (include 15/12/2019)
...
$web_link_qrcode = $GLOBALS['site_path']."visit_form/$proj_id/x_$form_id.php?link=$link_encode&bd=$is_backdate";

<?
$proj_id = isset($_GET["proj_id"])?$_GET["proj_id"]:"POC";
...
<div  class="div-uid-visit" id="div_uid_visit_list">
  <div class="card " id="div_uid_visit_list_schedule">
    <div class="card-body">
      <h5 class="card-title"><i class="fa fa-calendar-alt fa-lg" ></i> ตารางนัดหมาย <span class="text-primary" id="last_date_visit"></span> <span style="color:red;font-size:18px;"><b> นัดหมายในโครงการวันสุดท้ายไม่เกิน 30/09/2564 </b></span></h5>
          ...
          if(flag_enable == 0){// disable visit info button
            ...
            if(dataObj.status_id == '0'){ // pending visit
              ...
              if(dataObj.visit_id == "EX"){
                ...
                if(dataObj.visit_id == "SCRN"){
                    enroll_date = dataObj.visit_date;
                }
              }
...
*/
        ...
        enroll_date = new Date(enroll_date);
        // add a day
      ...
      //  $('#last_date_visit').html(" วันที่สุดท้ายที่สามารถเข้าพบได้คือ: <b><u>"+str+"</u></b> ");

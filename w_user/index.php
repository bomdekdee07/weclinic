...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-info">
    <a class="navbar-brand mr-4" href="change_menu.php?mnu="><i class="fas fa-clinic-medical"></i> IHRI <b>we</b>Clinic </a> <span class='badge badge-warning px-1 py-1'><? echo "$clinic_name";?></span>
...
$mnu_SUT = "";
$mnu_covid = "";
          if(isset($auth["data"]) || isset($auth["export"]) || isset($auth["query"]) || isset($auth["log"]) ){ // proj schedule


            if($s_section_id == "DATA" || $s_section_id == "TS"){ // for SDHOS
              $mnu_sdhos .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SDHOS" data-id="dashboard_center_pro"><i class="fa fa-hospital fa-lg" ></i> SDART Hospital Prospective</a>';
              $mnu_sdhos .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SDHOS" data-id="dashboard_center_retro"><i class="fa fa-hospital fa-lg" ></i> SDART Hospital Retrospective</a>';
            ...
            //  $mnu_SUT = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SUT_PRE" data-id="mnu_data_list"><i class="fa fa-file fa-lg" ></i> STANDUP-TEEN Pre Study</a>';
            ...
            if($s_group == "0"){ // cbo staff
                ...
                $mnu_surveygizmo = '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="mnu_surveygizmo"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo</a>';
            }
            else{ //

              if($s_group == "1"){ // ihri staff
                if($s_section_id == ""){ // ตรวจสอบ survey gizmo
                  $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="mnu_div_surveygizmo_all"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo - TRC</a>';
                }
                else if($s_section_id == "DATA"){
$mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="mnu_surveygizmo"><span class="text-primary"><i class="fa fa-kiwi-bird fa-lg" ></i> ดูฟอร์มจาก SurveyGizmo แบบ CBO</span></a>';
                  $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="mnu_surveygizmo_revise"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo (CBO)</a>';
                  $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="trc_mnu_surveygizmo_revise"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo (TRC)</a>';
                ...
                $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="trc_mnu_surveygizmo"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo - TRC</a>';
                $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="mnu_surveygizmo_revise"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo (CBO)</a>';
                $mnu_surveygizmo .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_SGM" data-id="trc_mnu_surveygizmo_revise"><i class="fa fa-file fa-lg" ></i> ตรวจฟอร์มจาก SurveyGizmo (TRC)</a>';
                $mnu_covid .= '<a class="dropdown-item mnu-external" href="javascript:void(0);" data-path="w_proj_covid19" data-id="mnu_data_list"><i class="fa fa-file fa-lg" ></i> COVID S&D</a>';

...
FROM p_project_uid_list as uv
WHERE uv.proj_id='$proj_id'
AND uv.uid_status=1 and uv.uid IN ('P16-03396', 'P19-08698')
ORDER BY uv.pid asc
";
//echo $query;
...
echo " <br><br>
UPDATE p_project_uid_visit SET visit_date = schedule_date WHERE visit_id='SCRN' ; <br>
UPDATE p_project_uid_visit SET visit_date = schedule_date WHERE visit_id='M0' ; <br>
UPDATE p_project_uid_visit SET group_id = '' WHERE visit_id='SCRN' ; <br>
UPDATE p_project_uid_visit SET visit_status = '1' WHERE visit_id IN ('SCRN', 'M0') ;

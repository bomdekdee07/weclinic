...
<div class="card">
  <div  class="card-header ">
   <h5><i class="fa fa-user fa-lg" ></i> <b>ข้อมูลผู้รับบริการ</b></h5>
  </div>
  <div class="card-body">
...
function getPersonalData_pid(){
  ...
  save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",getPersonalData_pidComplete);
...
function savePersonalData_pid(){
  ...
  if(validateInput("div_hos1")){
    ...
    save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",savePersonalData_pidComplete);

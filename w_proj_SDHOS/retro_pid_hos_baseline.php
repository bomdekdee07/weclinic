<div class="fixme">
  <div class="row my-1 bg-info">
     <div class="col-sm-3 py-1 text-white">
       <b><i class="fa fa-notes-medical fa-lg"></i>Retrospective Baseline</b>
     </div>
...
$(window).scroll(function() {                  // assign scroll event listener
 ...
 function getBaseline_pid(){
   ...
   var link = "w_proj_SDHOS/retro_pid_hos_baseline_form.php?";
...
//after_goHosMnu();
      ...
      function getPID_BirthYear(){
        //alert("checkExistLogData 1 ");

          var aData = {
                    u_mode:"get_pid_birth_year",
                    pid:cur_hos_pid
          };
          save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid_retro.php",getPID_BirthYearComplete);

        }
        function getPID_BirthYearComplete(flagSave, rtnDataAjax, aData){
          //alert("flag save is getPersonalData_pidComplete : "+flagSave);
          if(flagSave){
            $("#birth_yr").val(rtnDataAjax.birth_yr);
          }
        }

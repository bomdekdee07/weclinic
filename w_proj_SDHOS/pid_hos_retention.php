...
function getRetentionForm_pid(visitDate){
  ...
  var link = "w_proj_SDHOS/pid_hos_retention_form.php?";
...
function getRetention_pid(){
 ...
 function getRetentionList_pid(){
   //alert("getRetention_pid 1 ");
     ...
     save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",getRetentionList_pidComplete);
...
*/
      ...
      if (result) {
        ...
        save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",delete_retentionComplete);
    ...
    function delete_retentionComplete(flagSave, rtnDataAjax, aData){
      ...
      function remove_ae(collectDate){
          ...
          save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",remove_aeComplete);
      }

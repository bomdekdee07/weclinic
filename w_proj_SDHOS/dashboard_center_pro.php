...
function searchData_hos_pid(){
      ...
      save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",searchData_hos_pidComplete);
  ...
  $('#title_hos_pid_detail').html("PID: "+cur_hos_pid+" / UL: "+cur_hos_ul);
    ...
    function checkExistLogData(logForm, visitDate){
      //alert("checkExistLogData 1 ");
        ...
        save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",checkExistLogDataComplete);
...
function exportData_hos_pid(){
  if($('#search_hos_opt').val() == null){
    ...
    return;
      ...
      save_data_ajax(aData,"w_proj_SDHOS/xls_sdhos_data_export.php",exportData_hos_pidComplete);
...
function exportData_hos_pid_all(){
      ...
      save_data_ajax(aData,"w_proj_SDHOS/xls_sdhos_data_export_all.php",exportData_hos_pidComplete);
...
/*
      function getMaxSeqNo(logForm){ // get max seq_no to insert new log record (eg. AE)
        //alert("checkExistLogData 1 ");
          ...
          save_data_ajax(aData,"w_proj_SDHOS/db_hos_pid.php",getMaxSeqNoComplete);

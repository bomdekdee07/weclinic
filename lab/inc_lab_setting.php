...
$arr_setting_tbl["sale_option"]["col_sel_list"] = "sale_opt_id as id, sale_opt_name as name, data_seq AS seq ";
$arr_setting_tbl["sale_option"]["col_sel_detail"] = "sale_opt_id as id, sale_opt_name as name, data_seq AS seq ";

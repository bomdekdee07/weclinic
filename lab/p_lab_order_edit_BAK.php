      ...
      <div class="row mt-0">
        <div class="col-sm-9 ">
          ...
          <div class="my-1">
              ...
              <button type="button" class="py-1 my-1 btn btn-sm btn-warning  btn-lab-package2"
              data-pkg_lab="'BA%', 'EO%', 'Hb', 'HCT', 'LY%',
              'MCH', 'MCHC', 'MCV', 'MO%', 'MPV', 'NE%', 'PLT', 'RBC', 'RDW-CV', 'WBC'" >
...
<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="IMACT_SCRN" data-projid='IMACT' data-visitid='SCRN' >

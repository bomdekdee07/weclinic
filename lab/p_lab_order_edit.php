...
// include('../in_db_conn.php') // LOCAL;
include(realpath($_SERVER["DOCUMENT_ROOT"])."/weclinic/in_db_conn.php"); // DEMO
    ...
    <div class="card-body">
      <div class="row mt-0">
        <div class="col-sm-9 ">
          ...
          <div class="my-1">
              <button type="button" class="py-1 btn btn-sm btn-info btn-lab-package" data-lmt_id="LMT04" data-id="CBC" style="display: none;"><i class="fa fa-clipboard-check fa-lg" ></i> CBC</button>
              <button type="button" class="py-1 my-1 btn btn-sm btn-warning  btn-lab-packageitem"
              data-pkg_lab="'BA%', 'EO%', 'Hb', 'HCT', 'LY%',
              'MCH', 'MCHC', 'MCV', 'MO%', 'MPV', 'NE%', 'PLT', 'RBC', 'RDW-CV', 'WBC'" data-packageid="CBC_PAK" data-projid='' data-visitid=''>
              <i class="fa fa-clipboard-check fa-lg" ></i> CBC Innotech</button>
              ...
              <button type="button" class="py-1 btn btn-sm btn-info btn-lab-package" style="background-color:#117A65; color:white;" data-lmt_id="LMT83" data-id="CD8"><i class="fa fa-clipboard-check fa-lg" ></i> CD8</button>
...
data-packageid="IFACT_SCRN" data-projid='IFACT' data-visitid='SCRN' style="background-color:blue; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> IFACT3 Screen</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="IMACT_SCRN" data-projid='IMACT' data-visitid='SCRN' style="background-color:#008CBA; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> IMACT Screen</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="IMACT_EXTRA" data-projid='IMACT' data-visitid='EXTRA' style="background-color:#008CBA; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> IMACT Extra</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="HSILI_SCRN" data-projid='HSIL_I' data-visitid='SCRN' style="background-color:#F5B041; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> Anal HSILI Screen</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="SDART_SCRN" data-projid='SDART' data-visitid='SCRN' style="background-color:#E67E22; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> CBOs SDART Screen</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<!-- HSIL -->
<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="HSILI_IISCRN" data-projid='HSIL_II' data-visitid='BL' style="background-color:#85929E; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> Anal HSILII Screen</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="HSILI_IITP2" data-projid='HSIL_II' data-visitid='' style="background-color:#85929E; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> Anal HSILII TP2</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="SEATRANS" data-projid='SEA_TRANS' data-visitid='' style="background-color:#9B59B6; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> SEATRANS</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>

<button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-packageitem"
data-packageid="PURPOSE2" data-projid='PURPOSE2' data-visitid='SCAN' style="background-color:#008CBA; color:white;">
<i class="fa fa-clipboard-check fa-lg" ></i> PURPOSE2 Scan</button>
<i class='fa fa-spinner spinner fa-2x' style='display:none;'></i>
<!-- <button type="button" class="py-1 my-1 btn btn-sm btn-white btn-lab-package3" style="background-color:#F876FA; color:white;" data-visitid='SCRN' data-pkg_lab="PURPOSE2" ><i class="fa fa-clipboard-check fa-lg" ></i> PURPOSE2 </button> -->
  ...
  -->
      ...
      <button type="button" id="btn_save_lab_order" data-projid="" class="btn btn-success mx-1 float-right btn-lab-order" > <i class="fa fa-save fa-lg" ></i> Save Data</button>
...
$(document).ready(function(){
  ...
  $(".btn-lab-package3").click(function(){
    var pkg_lab = $(this).data("pkg_lab");
    $("#btn_save_lab_order").attr("data-projid", pkg_lab);
    addPackageLab3(pkg_lab);
  }); // btn-lab-package2 query from package-item
...
//console.log("flag: "+flag_save_update+"/"+flag_labtest_update);
  if(flag_save_update == "1" || flag_labtest_update == "1"){
      var proj_id = $("#btn_save_lab_order").attr("data-projid");
...
function addPackageLab3(pkg_lab){
  var lab_id_order = []; // list lab id to ignore to search
  $(".r_labtest_order").each(function(ix,objx){
    lab_id_order.push($(objx).data("lab_id"));
  });

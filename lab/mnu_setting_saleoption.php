...
<div id='div_setting_detail' class="div-setting-menu my-0" style="display:none;">
    <div id='div_setting_detail_form' >
        <div class=" my-1" style="background-color:#eee;">
            <center>Record ID: <input type="text" id="s<? echo $setting_col_id; ?>" value="xx" size="20" disabled></center>
        </div>
        <div class="row my-1">
        <div class="col-sm-12">
            <label for="sale_opt_name">Name:</label>
            <input type="text" id="sale_opt_name" data-title="Name"  class="form-control form-control-sm save-data v-no-blank " maxlength="150">
        </div>

        </div>
        <div class="row my-1">
            <div class="col-sm-12">
                <label for="data_seq">Seq:</label>
                <input type="number" id="data_seq" data-title="Seq"  class="form-control form-control-sm save-data v-no-blank " maxlength="150">
            </div>
        </div>
    </div>
...
<script>
    ...
    var arr_obj = [$('#sale_opt_name').val(), $('#data_seq').val()];
        ...
        if(rtnDataAjax.datalist.length > 0){
            ...
            var txt_row = "";
                for (i = 0; i < datalist.length; i++) {
                    ...
                    var arr_obj = [dataObj.name, dataObj.seq];

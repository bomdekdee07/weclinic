...
$lab_order_id = isset($_POST["oid"])?$_POST["oid"]:"";
...
//$html .= "<table><tr>";
  ...
  if($arr_data_lab_order["proj_id"] == "SDART"){
    ...
    // if($arr_data_lab_order["proj_visit"] == "SCAN" && $arr_data_lab_order["timepoint_id"] == ""){
    //   $convert_lab_proj_name_SDART = $arr_data_lab_order["proj_id"];
    //   $visit_SDART = "Incidence Screen";
    // }
    // else{
    //   $convert_lab_proj_name_SDART = $arr_data_lab_order["proj_id"];
    //   $visit_SDART = "Random Screen";
    // }
  }
  else{
    $convert_lab_proj_name_SDART = $arr_data_lab_order["proj_id"];
